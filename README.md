...
Accompanist is a group of libraries which aim to supplement [Jetpack Compose][compose] with features which are commonly required by developers, but not yet available. This version is meant to port some of these libraries to JetBrains Compose, allowing for them to be used on Desktop. 
